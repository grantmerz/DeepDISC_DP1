...
Running on small cutouts for photo-z: 

DP1_photo-z_cutouts_custom_scarlet.ipynb - runs custom scarlet implementation on DP1 cutouts, with a known detection catalog
